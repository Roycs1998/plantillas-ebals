			...
			<div class="row">
				<div class="col-xs-12 col-lg-9 col-xl-9 col-md-9 col-sm-12">
					<div class="top-address text-left">
						<p>				
							<a href="#"><i class="fas fa-phone-alt"></i>+51 957404672</a>
							<a href="#"><i class="fas fa-envelope"></i>ebelin@ecorporacionebals.com</a>
						</p>
					</div>
				</div>
				<!-- TOP RIGHT -->
							...
							<div class="solutech_nav_area scroll_fixed postfix">
								<div class="container">
									<div class="row logo-center">				
										...
										<div class="col-md-4 col-sm-4 col-xs-4 diseno_logo">
											<div class="logo">
												<a class="main_sticky_main_l" href="inicio" title="ebals">
													<img src="assets/images/logo2.png" alt="ebals">
												</a>
												<a class="main_sticky_l" href="inicio" title="ebals">
													<img src="assets/images/logo2.png" alt="ebals">
												</a>
											</div>	  
										</div>
			...
			<div class="col-sm-12">
				<div class="mobile_menu_logo text-center">
					<a href="index.html" title="solutech">
						<img src="assets/images/favicon.png" alt="solutech">
					</a>		
				</div>
			</div>
		</div>
